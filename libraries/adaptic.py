...
class adaptic:
    ...
    def gaussStrainB_create(self):  
        self.hasAttribute("gaussName")
        self.gaussStrainB = self.convertNum(self.wordsNum,"#ie1s",3,2,"float")
 
    def gaussStrainT_create(self): 
        self.hasAttribute("gaussName")
        self.gaussStrainT = self.convertNum(self.wordsNum,"#ie1s",3,4,"float")
 
    def gaussStressB_create(self):
        self.hasAttribute("gaussName")
        self.gaussStressB = self.convertNum(self.wordsNum,"#ie1s",3,3,"float")
 
    def gaussStressT_create(self):  
        self.hasAttribute("gaussName")
        self.gaussStressT = self.convertNum(self.wordsNum,"#ie1s",3,5,"float") 
    ...
    def All(self):                 
        ...
        self.hasAttribute("gaussStrainB")
        self.hasAttribute("gaussStrainT")        
        self.hasAttribute("gaussStressB")
        self.hasAttribute("gaussStressT") 
    ...
    def findIndice(self, att, ID):
        ...
        if att == "lnk2M1" or att == "lnk2M2" or att == "lnk2F_create":
            att = "lnk2Name"
        if att == "gaussStrainB" or att == "gaussStrainT" or att == "gaussStressB" or att == "gaussStressT":
            att = "gaussName"
